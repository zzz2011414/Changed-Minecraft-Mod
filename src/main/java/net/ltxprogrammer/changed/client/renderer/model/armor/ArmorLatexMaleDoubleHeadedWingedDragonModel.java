...
public class ArmorLatexMaleDoubleHeadedWingedDragonModel<T extends ChangedEntity & DoubleHeadedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMaleDoubleHeadedWingedDragonModel<T>> implements DoubleHeadedModel<T> {
    ...
    private final HumanoidAnimator<T, ArmorLatexMaleDoubleHeadedWingedDragonModel<T>> animator;

    public ArmorLatexMaleDoubleHeadedWingedDragonModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexMaleDoubleHeadedWingedDragonModel<T>> getAnimator(T entity) {
        return animator;
    }
